namespace DMS.Data.Migrations
{
    ...
    public partial class dms : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        Represent = c.String(maxLength: 256),
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.OrderCategories", t => t.OrderCategoryID, cascadeDelete: true)
            ...
            CreateTable(
                ...
                c => new
                    {
                        ...
                        Warranty = c.Int(),
                        Description = c.String(maxLength: 500),
                        SerialNumber = c.String(maxLength: 256),
                        Content = c.String(),
                        HomeFlag = c.Boolean(),
                        HotFlag = c.Boolean(),
                        ViewCount = c.Int(),
                ...
                .ForeignKey("dbo.UnitProducts", t => t.UnitID, cascadeDelete: true)
            ...
            CreateTable(
                ...
                .PrimaryKey(t => new { t.ProviderID, t.TagID })
                .ForeignKey("dbo.Providers", t => t.ProviderID, cascadeDelete: true)
                .ForeignKey("dbo.Tags", t => t.TagID, cascadeDelete: true)
                .Index(t => t.ProviderID)
                .Index(t => t.TagID);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.ProviderTags", "TagID", "dbo.Tags");
            DropForeignKey("dbo.ProviderTags", "ProviderID", "dbo.Providers");
            ...
            DropForeignKey("dbo.Products", "UnitID", "dbo.UnitProducts");
            ...
            DropIndex("dbo.ProviderTags", new[] { "TagID" });
            DropIndex("dbo.ProviderTags", new[] { "ProviderID" });
